...
const defaultDescs = {
	...
	"Add Obsidian Tags": "Interpret #tags in the fields of a note as Anki tags, removing them from the note text in Anki. The # prefix is also automatically stripped when using tags in the Tags: and FILE TAGS lines."
}
...
export class SettingsTab extends PluginSettingTab {
	...
	setup_display() {
		...
		containerEl.empty()
		containerEl.createEl('h2', {text: 'Obsidian 2 Anki settings'})
