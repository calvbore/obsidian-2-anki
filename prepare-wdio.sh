...
# Copy Built plugin
rm -rf tests/defaults/test_vault/.obsidian/plugins/obsidian-2-anki 
mkdir -p tests/defaults/test_vault/.obsidian/plugins/obsidian-2-anki 
cp manifest.json styles.css main.js tests/defaults/test_vault/.obsidian/plugins/obsidian-2-anki/
